...
import { ClaudeAgentFormatter } from './services/claude-agent-formatter';
...
let claudeFormatter: ClaudeAgentFormatter;
...
function getEnhancedCLIContent(): string {
...
app.get('/api/agents/:applicationId/claude', async (req: Request, res: Response) => {
  try {
...
app.delete('/api/agents/:applicationId', async (req: Request, res: Response) => {
  try {
    const { applicationId } = req.params;
...
app.delete('/api/agents/:applicationId/:agentId', async (req: Request, res: Response) => {
  try {
...
app.put('/api/agents/:applicationId/reset', async (req: Request, res: Response) => {
  try {
    const { applicationId } = req.params;
...
// Update Agent Status
app.put('/api/agents/:applicationId/:agentId', async (req: Request, res: Response) => {
  try {
    const { applicationId, agentId } = req.params;
    ...
    const result = await db.collection('dynamic_agents').updateOne(
      { applicationId, id: agentId },
      { $set: updateData }
    );
...
async function start() {
  try {
    ...
    claudeFormatter = new ClaudeAgentFormatter();
